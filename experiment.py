...
def main(epochs, cpu, cudnn_flag, visdom_port, visdom_freq, temp_dir, seed, no_bias_decay, max_norm, resume, 
            desc_name, use_bottleneck, use_duplicate):
    ...
    # Daniel: add here, or otherwise cause error since "module." name is added
    ...
    for epoch in range(epochs):
        ...
        train_one_epoch(model=model, loader=loaders.train, class_loss=class_loss, optimizer=optimizer, scheduler=scheduler, max_norm=max_norm, epoch=epoch, freq=visdom_freq, ex=ex)
